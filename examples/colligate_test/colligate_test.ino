// original code taken from https://github.com/lcdwiki/LCDWIKI_SPI/tree/master/Example/Example_02_colligate_test/colligate_test

#include <LCDWIKI_GUI.h> //Core graphics library
#include <SSD1283A.h> //Hardware-specific library

SSD1283A_GUI my_lcd(SS, 0, 2, 4); //hardware spi,cs,cd,reset,led
